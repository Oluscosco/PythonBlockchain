...
ax.set_ylabel("The Volume (ETH)", fontweight='heavy', labelpad=20)
...
ax2.set_ylabel("The Average Price (ETH)", fontweight='heavy', rotation=270, labelpad=20)
ax2.spines['top'].set_visible(False)
ax2.spines['right'].set_visible(False)
ax2.spines['bottom'].set_visible(False)
ax2.spines['left'].set_visible(False)

plt.title('CoolDee Volume and price (CryptoPunks)', loc='left', fontsize=16, fontweight="heavy", verticalalignment="top")
plt.show()
